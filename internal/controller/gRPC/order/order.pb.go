// internal/controller/gRPC/order/order.proto
...
func (x *QueryOrdersRequest) Reset() {
	*x = QueryOrdersRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_controller_gRPC_order_order_proto_msgTypes[0]
...
func (*QueryOrdersRequest) Descriptor() ([]byte, []int) {
	return file_internal_controller_gRPC_order_order_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetOrderDetailRequest) Reset() {
	*x = GetOrderDetailRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_controller_gRPC_order_order_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetOrderDetailRequest) Descriptor() ([]byte, []int) {
	return file_internal_controller_gRPC_order_order_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetOrderDetailResponse) Reset() {
	*x = GetOrderDetailResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_controller_gRPC_order_order_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetOrderDetailResponse) Descriptor() ([]byte, []int) {
	return file_internal_controller_gRPC_order_order_proto_rawDescGZIP(), []int{2}
}
...
func (x *QueryOrdersResponse) Reset() {
	*x = QueryOrdersResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_controller_gRPC_order_order_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*QueryOrdersResponse) Descriptor() ([]byte, []int) {
	return file_internal_controller_gRPC_order_order_proto_rawDescGZIP(), []int{3}
}
...
func (x *Order) Reset() {
	*x = Order{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_controller_gRPC_order_order_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Order) Descriptor() ([]byte, []int) {
	return file_internal_controller_gRPC_order_order_proto_rawDescGZIP(), []int{4}
}
...
func (x *OrderItem) Reset() {
	*x = OrderItem{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_controller_gRPC_order_order_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OrderItem) Descriptor() ([]byte, []int) {
	return file_internal_controller_gRPC_order_order_proto_rawDescGZIP(), []int{5}
}
...
func (x *OrderDetail) Reset() {
	*x = OrderDetail{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_controller_gRPC_order_order_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OrderDetail) Descriptor() ([]byte, []int) {
	return file_internal_controller_gRPC_order_order_proto_rawDescGZIP(), []int{6}
}
...
var File_internal_controller_gRPC_order_order_proto protoreflect.FileDescriptor

var file_internal_controller_gRPC_order_order_proto_rawDesc = []byte{
	0x0a, 0x2a, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x6f, 0x6e, 0x74, 0x72,
	0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x2f, 0x67, 0x52, 0x50, 0x43, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72,
	0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x22, 0x9a, 0x01, 0x0a, 0x12, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x74,
	...
	0x44, 0x61, 0x74, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64,
	...
	0x65, 0x72, 0x49, 0x64, 0x22, 0x52, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72,
	...
	0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x88, 0x01, 0x0a, 0x13, 0x51, 0x75, 0x65,
	...
	0x74, 0x61, 0x69, 0x6c, 0x52, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x12, 0x14, 0x0a, 0x05,
	...
	0x69, 0x7a, 0x65, 0x22, 0xd5, 0x01, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x19, 0x0a,
	...
	0x69, 0x6d, 0x65, 0x12, 0x26, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x07, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x73, 0x0a, 0x09, 0x4f,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x69, 0x74, 0x65, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1a,
	...
	0x22, 0xdb, 0x01, 0x0a, 0x0b, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c,
	...
	,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x27, 0x5a, 0x25, 0x54, 0x61, 0x75, 0x72,
	0x75, 0x73, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x6f, 0x6e, 0x74,
	0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x2f, 0x67, 0x52, 0x50, 0x43, 0x2f, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_internal_controller_gRPC_order_order_proto_rawDescOnce sync.Once
	file_internal_controller_gRPC_order_order_proto_rawDescData = file_internal_controller_gRPC_order_order_proto_rawDesc
)

func file_internal_controller_gRPC_order_order_proto_rawDescGZIP() []byte {
	file_internal_controller_gRPC_order_order_proto_rawDescOnce.Do(func() {
		file_internal_controller_gRPC_order_order_proto_rawDescData = protoimpl.X.CompressGZIP(file_internal_controller_gRPC_order_order_proto_rawDescData)
	})
	return file_internal_controller_gRPC_order_order_proto_rawDescData
}

var file_internal_controller_gRPC_order_order_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_internal_controller_gRPC_order_order_proto_goTypes = []interface{}{
...
var file_internal_controller_gRPC_order_order_proto_depIdxs = []int32{
...
func init() { file_internal_controller_gRPC_order_order_proto_init() }
func file_internal_controller_gRPC_order_order_proto_init() {
	if File_internal_controller_gRPC_order_order_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_internal_controller_gRPC_order_order_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_controller_gRPC_order_order_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_controller_gRPC_order_order_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_controller_gRPC_order_order_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_controller_gRPC_order_order_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Order); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_controller_gRPC_order_order_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_controller_gRPC_order_order_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_internal_controller_gRPC_order_order_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_internal_controller_gRPC_order_order_proto_goTypes,
		DependencyIndexes: file_internal_controller_gRPC_order_order_proto_depIdxs,
		MessageInfos:      file_internal_controller_gRPC_order_order_proto_msgTypes,
	}.Build()
	File_internal_controller_gRPC_order_order_proto = out.File
	file_internal_controller_gRPC_order_order_proto_rawDesc = nil
	file_internal_controller_gRPC_order_order_proto_goTypes = nil
	file_internal_controller_gRPC_order_order_proto_depIdxs = nil
}
